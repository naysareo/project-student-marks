            ...
            while True:
                ...
                while True:
                    ...
                    try:
                        ...
                        print(
                            '\nВведены неверные данные. Проверьте ввод, повторите попытку. Или введите'
                            '(E) для выхода.\n')
            return database_local
    ...
    while True:
        ...
        def load_data_to_database(database_name, data_dict):
            ...
            for key, value in data_dict.items():
                cursor.execute('''INSERT OR REPLACE INTO my_table (key, value) VALUES (?, ?)''',
        ...
        load_data_to_database('project_student_marks_database.bd', database_dict)
